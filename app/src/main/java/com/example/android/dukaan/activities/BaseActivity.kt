...
// Step 3: Create an open class name as BaseActivity and inherits the AppCompatActivity class.
/**
...
open class BaseActivity : AppCompatActivity() {
    ...
    //  Step 4: Create a function to show the success and error messages in snack bar component.
    // START
    /**
